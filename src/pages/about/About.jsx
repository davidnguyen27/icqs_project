      ...
      <div className="body-part3">
        <Container>
          <Typography variant="h5" gutterBottom className="title">
            My House chia thành hai mảng dịch vụ chính để mang đến trải nghiệm
            mua sắm toàn diện cho người dùng
            ...
            {dataBodyPart2.map((item, index) => (
              <Grid item xs={2} sm={4} md={4} key={index}>
                ...
                >
                  ...
                  <span className="description-bodypart2">
                    {item.description}
                  </span>
                </div>
              </Grid>
